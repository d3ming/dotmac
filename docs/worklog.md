...
Keep Dotmac as the source of truth for personal Mac setup and make new-Mac onboarding quick, clear, and agent-led.
...
Use the README quick start on a new Mac. Keep optional apps and system preferences separate so they can be requested after the core setup.
